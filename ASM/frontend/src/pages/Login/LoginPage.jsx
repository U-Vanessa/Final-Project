            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="terms-acceptance-box">
                <label className="terms-checkbox-label">
                  ...
                  />
                  <span>
                    I accept the <strong>Terms of Reference</strong> and <strong>Policies</strong> to operate ASM as
        ...
        <div className="policy-modal-overlay" role="dialog" aria-modal="true" aria-label="Terms and Policies">
          <div className="policy-modal-content">
            ...
            <div className="policy-modal-body">
              ...
              <p>
                ASM is for authorized operational use by approved User and IT Personnel accounts only. Access is role-
